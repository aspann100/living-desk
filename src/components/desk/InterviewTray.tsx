...
export function InterviewTray() {
  ...
  const glow =
    phase === "idle"
      ? "0 0 0 2px var(--tray-glow)"
      : phase === "armed" || isOver
        ? "0 0 0 3px var(--stamp-red), 0 0 18px var(--tray-glow)"
        : "0 0 0 2px var(--stamp-red-soft)";
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: "1px solid color-mix(in srgb, var(--stamp-red) 28%, transparent)",
      }}
      animate={
        shaking && !reduce
          ? { x: [0, -6, 6, -4, 4, 0] }
